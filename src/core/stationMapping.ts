...
export const STATION_DATABASE: StationData[] = [
  ...
  { id: 'RAM', name: 'Ramsey', position: { lat: 41.0570, lng: -74.1400 }, aliases: ['Ramsey Route 17'] },
  ...
  { id: 'GLE', name: 'Glen Rock', position: { lat: 40.9630, lng: -74.1280 }, aliases: ['Glen Rock - Boro Hall', 'Glen Rock - Main Line'] },
